              ...
              child: Stack(
                children: [
                  ClipRRect(
                    borderRadius: BorderRadius.circular(10),
                    child: Image.asset(
                      widget.product['imagePath'], // <-- pakai 'widget.'
                      fit: BoxFit.cover,
                    ),
                  ),
                  ...
                  Positioned(
                    top: 5,
                    right: 5,
                    child: GestureDetector( // <-- Dibungkus GestureDetector
                      onTap: _toggleFavorite,
                      child: Icon( // <-- Container putih dihilangkan
                        _isFavorite ? Icons.favorite : Icons.favorite_border, // <-- Ikon dinamis
                        color: Colors.red,
                  ...
                  Row(
                    ...
                    children: [
                      const Column(
                        crossAxisAlignment: CrossAxisAlignment.start,
                        children: [
                          Text('FREE Delivery', style: TextStyle(color: Colors.green, fontWeight: FontWeight.bold, fontSize: 12)),
                          Text('40% Off', style: TextStyle(color: Colors.red, fontWeight: FontWeight.bold, fontSize: 12)),
                        ],
                      ),
