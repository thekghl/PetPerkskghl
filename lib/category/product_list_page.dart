...
class _ProductListPageState extends State<ProductListPage> {
  ...
  final List<Map<String, dynamic>> products = const [
    {'name': 'Dog Body Belt', 'price': 80, 'oldPrice': 95, 'review': 2, 'imagePath': 'assets/belt_product.jpg'},
    {'name': 'Pet Bed For Dog', 'price': 80, 'oldPrice': 95, 'review': 2, 'imagePath': 'assets/bed_product.jpg'},
    {'name': 'Dog Cloths', 'price': 80, 'oldPrice': 95, 'review': 2, 'imagePath': 'assets/cloths_product.jpg'},
    {'name': 'Dog Chew Toys', 'price': 80, 'oldPrice': 95, 'review': 2, 'imagePath': 'assets/chew_toys_product.jpg'},
  ];
  ...
  final List<String> _filterCategories = [
    ...
    'Vouchers',
    'Top Rated',
    'Newest' // Menambah beberapa item untuk demonstrasi scroll
  ];
          ...
          children: [
            ...
            Positioned(
              ...
              child: Container(
                ...
                child: const Text('14', style: TextStyle(color: Colors.white, fontSize: 8), textAlign: TextAlign.center),
              ),
            ),
          ],
        ),
  ...
  Widget _buildFilterChips() {
    ...
    return Padding(
      ...
      child: SizedBox(
        height: 35, // Tinggi yang pas untuk chip (konsisten dengan SearchScreen)
  ...
  Widget _buildBanner() {
    return Padding(
      ...
      child: Container(
        ...
        decoration: BoxDecoration(color: const Color(0xFF1F3D78), borderRadius: BorderRadius.circular(10)),
        child: Padding(
          ...
          child: Row(
            ...
            children: [
              const Column(
                ...
                children: [
                  Text('Samar', style: TextStyle(color: Colors.white, fontSize: 18, fontWeight: FontWeight.bold)),
                  Text('Agency WordPress Theme', style: TextStyle(color: Colors.white70, fontSize: 12)),
                ],
              ),
              ElevatedButton(
                onPressed: () {},
  ...
  Widget _buildBottomActionBar(BuildContext context) {
    return Container(
      ...
      child: Row(
        ...
        children: [
          _buildActionButton(context, Icons.person_outline, 'GENDER', const GenderBottomSheet()),
          _buildActionButton(context, Icons.arrow_upward, 'SORT', const SortBottomSheet()),
          _buildActionButton(context, Icons.filter_list, 'FILTER', const FilterBottomSheet()),
        ],
      ),
    );
  }

  Widget _buildActionButton(BuildContext context, IconData icon, String label, Widget modalContent) {
    return Expanded(
      child: InkWell(
        onTap: () {
